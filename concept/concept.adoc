= XDS Document Service der "ePA für alle"
:title-page:
...
image::IHE-XDS-Implementierungsstrategie.svg[caption="Abbildung {counter:figure}: ", reftext="Abbildung {figure}", title="IHE XDS-Implementierungsstrategie mit zentraler Registry und Repository",width=80%, pdfwidth=80%,float="center",align="center",title-align="center"]
...
ifdef::backend-pdf[]
.A
image::IHE-XDS-Transaktionsübersicht.png[caption="Abbildung {counter:figure}: ", reftext="Abbildung {figure}", title="Überblick über IHE ITI-Akteure und assoziierte Transaktionen",width=100%, pdfwidth=100%,float="center",align="center",title-align="center"]
endif::[]
ifeval::["{backend}" == "html5"]
image::IHE-XDS-Transaktionsübersicht.svg[caption="Abbildung {counter:figure}: ", reftext="Abbildung {figure}", title="Überblick über IHE ITI-Akteure und assoziierte Transaktionen",width=100%, pdfwidth=100%,float="center",align="center",title-align="center"]
endif::[]
...
_Hinweis: Kursiv dargestellte IHE ITI-Akteure und Transaktionen sind als intern anzusehen und aus Sicht der Fachanwendung ePA nicht normativ._
...
=== Kategorienbasiertes Verbergen von Dokumenten ggü. einer Leistungserbringerinstitution
...
=== Dokumentenspezifisches Verbergen von Dokumenten ggü. einer Leistungserbringerinstitution
